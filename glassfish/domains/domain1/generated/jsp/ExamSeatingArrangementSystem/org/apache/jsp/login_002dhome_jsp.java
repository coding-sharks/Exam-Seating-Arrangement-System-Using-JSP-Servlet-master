...
public final class login_002dhome_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (session.getAttribute("login_level") != null) { 
      ...
      out.write("      <!-- main body --> \n");
      out.write("\t    <div style=\"width: 70%; float:left; margin-right:30px\" id=\"login-home\">\n");
      out.write("\t\t  <h2>Welcome to Examintion Seating Arrangement System</h2>\n");
      out.write("\t\t\t  \n");
      out.write("\t\t <!-- Dashboard For Super Admin Section -->\n");
      out.write("\t\t ");
 if(session.getAttribute("login_level") != null && session.getAttribute("login_level").equals("1")) { 
      out.write("\t\t\n");
      out.write("\t\t  <ul>\t\n");
      ...
      out.write("\t\t\t<li><a href=\"report-employee.jsp\">Users Reports</a></li>\n");
      out.write("\t\t\t<li><a href=\"change-password.jsp\">Change Password</a></li>\n");
      out.write("\t\t\t<li><a href=\"login.jsp?act=logout\">Logout</a></li>\n");
      out.write("\t\t  </ul>\n");
      out.write("\t\t  ");
 } 
      out.write("\n");
